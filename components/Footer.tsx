      ...
      >
        ...
        >
          ...
          <div style={col(0.2)}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "Freighter Wallet", href: "https://www.freighter.app" },
                { name: "Stellar Laboratory", href: "https://laboratory.stellar.org" },
                { name: "Stellar Expert", href: "https://stellar.expert/explorer/testnet" },
              ].map((item) => (
                <a
                  key={item.name}
                  href={item.href}
        ...
        <div style={{ ...col(0.3), borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 24, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <span style={{ fontFamily: "Inter,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            © 2026 Crefi Protocol · MIT License
          </span>
          <span style={{ fontFamily: "Inter,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            Stellar Testnet · Soroban Contracts Live
          </span>
        </div>
      </footer>
