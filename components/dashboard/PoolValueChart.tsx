...
const STORAGE_KEY = "crefi_protocol_pool_balance_history_v2";
...
export default function PoolValueChart({ poolBalance }: { poolBalance: number }) {
  ...
  useEffect(() => {
    if (!Number.isFinite(poolBalance) || poolBalance < 0) return;
  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      <div style={{ padding: "16px 20px 10px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ fontFamily: "Inter,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.4)" }}>POOL TVL (XLM)</div>
          <div style={{ fontSize: 30, color: "#F0F0F0", marginTop: 4 }}>
