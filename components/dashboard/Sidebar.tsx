...
export default function Sidebar({ active, onNav }: SidebarProps) {
  ...
  const [walletAddress, setWalletAddress] = useState("GCF...XLM");
    ...
    >
      ...
      <div style={{ padding: "20px 20px 16px", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 0 }}>
          <span className="font-display" style={{ fontSize: 18, fontWeight: 800, color: "#F0F0F0", letterSpacing: "-0.04em" }}>Crefi</span>
          <span className="font-display" style={{ fontSize: 18, fontWeight: 800, color: "#00FFD1", letterSpacing: "-0.04em" }}>Protocol</span>
        </div>
