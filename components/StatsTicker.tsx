...
const ROW1 = [
  { label: "XLM/USDC", value: "0.31 USDC" },
  { label: "Total Pool", value: "54,030 XLM" },
  { label: "Contract", value: "Lending Pool Live" },
  { label: null, value: "Stellar Testnet" },
];

const ROW2 = [
  { label: "Active Loans", value: "2" },
  { label: "Min AURA", value: "30 pts" },
  { label: null, value: "Soroban Contract" },
