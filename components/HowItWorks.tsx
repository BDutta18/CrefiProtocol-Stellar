...
const STEPS = [
  {
    ...
    desc: "Link Freighter wallet. Sign up with a password. Instant JWT session.",
    tag: "AUTH",
    tagColor: "#00FFD1",
  },
  {
    ...
    label: "EXEC",
    title: "Deposit XLM",
    desc: "Sign a transaction to deposit XLM into the pool and receive pool shares.",
    tag: "TXN",
    tagColor: "#7B2FFF",
  },
  {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          From wallet connection to yield generation - the full loop takes less than 60 seconds on Stellar testnet.
        </p>
      </div>
